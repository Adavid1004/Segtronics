...
public class Inventario extends javax.swing.JFrame {
    ...
    private void txtCódigoProductoKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCódigoProductoKeyPressed
        ...
        String Nombre = txtCódigoProducto.getText();
        try {
            DefaultTableModel modelo = new DefaultTableModel();
            modelo.addColumn("ID");
            modelo.addColumn("PRODUCTO");
            ...
            Connection cn = Conexion.conectar();
            PreparedStatement pst = cn.prepareStatement("select id_inventario ID, producto PRODUCTO, cantidad CANTIDAD, precio PRECIO,codigo CÓDIGO from inventario where producto LIKE '"+Nombre+"%' ");
            //bse de datos
            ResultSet rs = pst.executeQuery();  // para descargar datos
